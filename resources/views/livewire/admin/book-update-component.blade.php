        ...
        <ul class="media-list media-list-linked">
            ...
            <li class="media bg-light py-2">
                ...
                <div wire:ignore class="col-lg-10">
                    {{--                    <select multiple="" class="form-control select select2-hidden-accessible" style="width: 100%">--}}
                    {{--                        <optgroup label="Mountain Time Zone" data-select2-id="202">--}}
                    ...
                    <div class="form-group" data-select2-id="191">
                        <select multiple="" id="edit_categories" class="form-control select select2-hidden-accessible" data-fouc=""
                                data-select2-id="13" tabindex="-1" aria-hidden="true">
                            <optgroup label="دسته بندی ها" data-select2-id="202">
                                @foreach ($groups as $item)
                                    <option value="{{ $item->id }}"
                                    {{in_array( $item->id, $grouping_id) ? 'selected="selected"':''}}
                                    >{{ $item->title }}</option>
                                @endforeach
                            </optgroup>
